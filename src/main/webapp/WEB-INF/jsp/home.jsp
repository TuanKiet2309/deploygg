...
<head>
	...
	<link href="/resources/css/show_img.css" rel="stylesheet" type="text/css"></link>
...
<link href="/resources/img/WebResource.axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet">
<link href="/resources/img/WebResource(1).axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet">
<link href="/resources/img/WebResource(2).axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet">
</head>
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPaA8FDzhkNDcwMzhjYWEzZTMwZhgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAgURUmFkV2luZG93TWFuYWdlcjEFOmN0bDA2JHBvcnRsZXRfODAwODg2YTgtY2NiNS00MGRkLTgxM2EtMmMwMmFjMGQyZTkyJFJhZE1lbnWfrgw84AVllzRXhYcrNvEzDnKyeQ==">
</div>
...
<script src="/resources/img/WebResource(3).axd" type="text/javascript"></script>


<script src="/resources/Telerik.Web.UI.WebResource.axd" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
...
<script src="/resources/jsdebug" type="text/javascript"></script>
<script src="/resources/jsdebug(1)" type="text/javascript"></script>
<script src="/resources/jsdebug(2)" type="text/javascript"></script>
<script src="/resources/jsdebug(3)" type="text/javascript"></script>
<div>
...
<div class="truycap_ute">
    <p>Visit month:
        <span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">2,480</span></p>
    <p class="line_footer"></p>
    <p>Visit total:<span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">5,957</span></p>
</div>
